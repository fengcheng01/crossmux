...
static_assert(inkEnd(freeink::lut_m4_direct_pulse, 1) == 30);
static_assert(inkEnd(freeink::lut_m4_direct_pulse, 2) == 30);
static_assert(inkEnd(freeink::lut_m4_direct_pulse, 3) == 30);

static_assert(frames(freeink::lut_m4_from_white) == 60);
static_assert(frames(freeink::lut_m4_white_pulse) == 24);
static_assert(frames(freeink::lut_m4_direct_pulse) == 30);
...
static_assert(dose(freeink::lut_m4_direct_pulse, 1, 2) == 18);
static_assert(dose(freeink::lut_m4_direct_pulse, 2, 2) == 18);
